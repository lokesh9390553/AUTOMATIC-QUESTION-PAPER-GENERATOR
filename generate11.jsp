...
<FORM  NAME=comfrm ACTION="generate12.jsp" onSubmit="return formvalid()">
<CENTER>
<LABEL style="BORDER-BOTTOM-COLOR: khaki; COLOR: maroon; BORDER-BOTTOM-STYLE: groove">
<FONT SIZE="2" COLOR="navy">
<B>Generate  Questions Paper</B><br>
...
int a =0;
ResultSet rs=st.executeQuery("select max(pid) from descquestions");
...
String cmd="Select distinct unit from matchdesc where branch = '" + request.getParameter("branch") + "' and semester ='" + request.getParameter("semester") + "' and subject='" + subject + "'";
