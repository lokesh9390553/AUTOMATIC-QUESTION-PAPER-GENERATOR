...
<FORM  NAME=comfrm ACTION="generated333.jsp" onSubmit="return formvalid()">
<CENTER>
<LABEL style="BORDER-BOTTOM-COLOR: khaki; COLOR: maroon; BORDER-BOTTOM-STYLE: groove">
<FONT SIZE="2" COLOR="navy">
<B>Print Descriptive Questions Paper</B><br>
...
int a =0;
ResultSet rs=st.executeQuery("select distinct pid from descquestions  where branch ='" + request.getParameter("branch") + "' and semester ='" + request.getParameter("semester") + "'");
