...
<%
	...
	int a=0;
	ResultSet rs=st.executeQuery("select max(qno) from matchques where branch='" + branch + "' and semester='" + semester + "' and subject='" + request.getParameter("subject") + "'");
	...
	try{
	String cmd="INSERT INTO matchques VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
